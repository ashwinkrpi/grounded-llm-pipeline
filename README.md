...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/chapters-11%2F11-blueviolet" alt="chapters progress">
</p>
...
| 02 | 🧠 [Choosing and Installing Your Local Model](chapters/chapter-02-choosing-installing-local-model.md) | Matching a model to your hardware and task instead of chasing the trending name. |
| 03 | ⌨️ [Talking to Your Model in Code, Not Chat](chapters/chapter-03-talking-to-model-in-code.md) | Moving from the chat window to scripted API calls — the foundation of a repeatable pipeline. |
...
| 08 | 🎨 [Turning Text into a Finished Artifact](chapters/chapter-08-turning-text-into-finished-artifact.md) | Rendering generated text into a shareable image, card, or post ready to publish. |
...
| 11 | 🌍 [Adapting the Pipeline to Your Own Niche](chapters/chapter-11-adapting-pipeline-to-your-own-niche.md) | Swapping the scrape target and prompt to reuse the same skeleton for any topic. |

</details>

> ✅ **status:** All 11 chapters are live. The book is complete, end to end — scrape to rendered artifact.
...
- [x] 🕷️ **Scrape** — pull real source material from the web
- [x] 🧩 **Structure** — clean and chunk it into usable context
- [x] 🤖 **Generate** — prompt your local model for grounded, structured output
- [x] 🔍 **Validate** — reject any claim that can't be traced back to a source
- [x] 🖼️ **Render** — turn validated text into a finished, postable artifact
